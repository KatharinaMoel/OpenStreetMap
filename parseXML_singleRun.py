...
def collect_data(FILE = 'map.xml', csv_output = True, max_size = 1000000):
    ...
    try:
        ...
        with open(FILE, 'r') as read_file:
                    ...
                    if event == "end":
                        ...
                        if test_func(elem):
                            ...
                            # in case of a way tag:
                                ...
                                if id in streets:
                                    print('street already in streets')
                                print('ID: %s' %id)
                            ...
                            # in case of a relation tag: get the bounding ways (ids) of an postal area and save it to the postal_areas dict
                                ...
                                if postal_code in postal_areas:
                                    print('postal_code already in postal_areas')
            ...
            print('\t \t \t END NEW POS: \t %s' % read_file.tell())
